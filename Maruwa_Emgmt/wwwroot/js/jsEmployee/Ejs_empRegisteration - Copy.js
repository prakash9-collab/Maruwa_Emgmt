...
function AccessDefaultRadibutton() {
    ...
    $("input[name='cpmHandPhone'][value='N']").prop('checked', true);
    $("input[name='cpmHandphoneIssuedDate'][value='N']").prop('checked', true);

    $("input[name='cpmLaptop'][value='N']").prop('checked', true);
    $("input[name='cpmLaptopIssuedDate'][value='N']").prop('checked', true);

    $("input[name='cpmTablet'][value='N']").prop('checked', true);
    $("input[name='cpmTabletIssuedDate'][value='N']").prop('checked', true);

    $("input[name='cpmSimcard'][value='N']").prop('checked', true);
    $("input[name='cpmSimcardIssuedDate'][value='N']").prop('checked', true);

    $("input[name='cpmWalkieTalkie'][value='N']").prop('checked', true);
    $("input[name='cpmWalkieTalkieIssuedDate'][value='N']").prop('checked', true);

    $("input[name='cpmInternetAccess'][value='N']").prop('checked', true);
    $("input[name='cpmInternetAccessIssuedDate'][value='N']").prop('checked', true);
